...
namespace ProjectCdk
{
    public class ProjectPipelineStage : Stage
    {
        ...
        public ProjectPipelineStage(Construct scope, string id, StageProps props) : base(scope , id, props)
        {
            ...
            var service = new HelpDeskFargateStack(this, "HelpDeskEc2Stack", commonProps);//, getEndpoint = ds.getEndpoint, getByIDEndpoint = ds.getByIDEndpoint, putEndpoint = ds.putEndpoint, updateEndpoint = ds.updateEndpoint });
